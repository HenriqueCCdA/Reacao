...
/*... alocacao de memoria*/
  p    = (INT*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(p,"p");
  a    = (DOUBLE*)malloc(nEdo * nEdo * sizeof(DOUBLE));
  testAlloc(a,"a");
  w    = (DOUBLE*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(w,"w");
  dyt  = (DOUBLE*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(dyt,"dyt");
  del   = (DOUBLE*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(del,"del");
  yt   = (DOUBLE*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(yt,"yt");
  scale    = (DOUBLE*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(scale,"scale");
  dfdy    = (DOUBLE*)malloc(nEdo * nEdo * sizeof(DOUBLE));
  testAlloc(dfdy,"dfdy");
  ySeq     = (DOUBLE*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(ySeq,"ySeq");
  table     = (DOUBLE*)malloc(KMAXX * nEdo * sizeof(DOUBLE));
  testAlloc(table,"table");
  ySav      = (DOUBLE*)malloc(nEdo * sizeof(DOUBLE));
  testAlloc(ySav,"ySav");
/*...................................................................*/
